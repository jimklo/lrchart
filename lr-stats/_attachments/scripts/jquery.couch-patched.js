...
(function($) {
    ...
    $.extend($.couch, {
        ...
        activeTasks: function(options) {
            ...
            }, options, "Active task status could not be retrieved");
        },
        allDbs: function(options) {
            ajax({
                url: this.urlPrefix + "/_all_dbs"
            }, options, "An error occurred retrieving the list of all databases");
        },
        ...
        db: function(name, db_opts) {
            ...
            return {
                ...
                info: function(options) {
                    ajax({
                        url: this.uri
                    }, options, "Database information could not be retrieved");
                },
                changes: function(since, options) {
                    ...
                    function getChangesSince() {
                        ...
                        }, options, "Error connecting to " + db.uri + "/_changes.");
                    }
                ...
                removeDoc: function(doc, options) {
                    ajax({
                        type: "DELETE",
                        url: this.uri + encodeDocId(doc._id) + encodeOptions({
                            rev: doc._rev
                        })
                ...
                getDbProperty: function(propName, options, ajaxOptions) {
                    ...
                    }, options, "The property could not be retrieved", ajaxOptions);
                },
    ...
    function(xhr, type, s) { // lifted from jq1.4.4
    ...
    function ajax(obj, options, errorMessage, ajaxOptions) {
        ...
        if ($.couch && $.couch.defaultAjaxOpts) {
            defaultAjaxOpts = $.extend($.couch.defaultAjaxOpts, defaultAjaxOpts);
        }
        options = $.extend({
            successStatus: 200
        }, options);
    ...
    function encodeOptions(options) {
        ...
        if (typeof(options) === "object" && options !== null) {
            for (var name in options) {
                if ($.inArray(name, ["error", "success", "beforeSuccess", "ajaxStart"]) >= 0) continue;
